  ...
  return (
    <div>
      <div className="bg-gray-100 grid lg:grid-cols-2 2xl:grid-cols-5">
        <div className="px-8 py-12 mx-auto max-w-md sm:max-w-xl lg:px-12 lg:py-24 lg:max-w-full lg:mr-0 2xl:col-span-2">
          <div className="xl:max-w-xl">
            ...
            <img
              ...
              alt="working on workation"
            />
            <h1 className="mt-6 text-2xl font-headline font-semibold text-gray-900 sm:mt-8 lg:text-3xl xl:text-4xl">
